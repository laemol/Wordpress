...
<div id="page_caption" class="<?php if (!empty($pp_page_bg)) {
        ?>hasbg <?php echo esc_attr($parallax_class); ?><?php
    ...
    } ?> <?php if ($tour_header_type == 'Youtube Video' or $tour_header_type == 'Vimeo Video') {
        ...
        $tour_discount_price = get_post_meta($current_page_id, 'tour_discount_price', true); ?>
			<div class="single_tour_header_price">
				...
				<div class="single_tour_per_person">
					<?php esc_html_e('Per Person', 'grandtour'); ?> and you
				</div>
			</div>
			<?php
    } ?>
