                ...
                if ($result['orderId']) {
                    ...
                    <div class="payment-details">
                        ...
                        if ($_POST['payment_type'] == 'card') {
                            ...
                            if (!$result['paymentUrl']) {
                                ...
                                <form action="<?php echo lang_url() ?>return" method="POST">
                                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo STRIPE_KEY ?>" data-amount="<?php echo $result['totalPrice'] * 100 ?>" data-name="Order <?php echo $result['code'] ?>" data-email="<?php echo $_POST['email'] ?>" data-locale="auto" data-currency="eur" data-allow-remember-me="false">
                                    </script>
                        ...
                        ?>
                            ...
                            <a href="<?php echo $result['paymentUrl'] ?>" class="button">Pay with Mollie</a>
                    ...
                    ?> <script src=" https: //js.stripe.com/v3/"> </script>
                        <div class="payment-details">
                            <fo r m id="payment- form">

                                <p><s t r o ng><?php pll_e('Name'); ?></strong><br>
